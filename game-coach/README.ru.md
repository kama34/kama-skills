...
- **Ежедневный чекин** (5 мин) — трекинг стриков, XP, фокус на день
- **Менторская сессия** — глубокий GROW+WOOP коучинг для проработки целей
- **Dashboard** — полная визуализация прогресса с целями, квестами, бейджами
