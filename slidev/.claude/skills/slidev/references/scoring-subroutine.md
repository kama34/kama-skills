...
|---|---|---|---|---|
| **Composition variety** | Different archetype structures, icon-trio max 1, no >30% same layout | Same layout every slide; 3+ uniform icon containers on one slide | Some variation, 2-3 patterns | Each slide structurally distinct; icon containers vary in size, shape, or style |
...
| **Font discipline** | Strictly 2 font identities, body ≥1.25rem, headings ≥2.2rem, line-height 1.3-1.45, bold ≤15% | 3+ fonts, numbers in different font; >3 type treatments on one slide; italic outside quotes; blacklisted font for number-heavy deck | Mostly 2 but some inconsistency | Exactly 2 fonts, numbers consistent; max 3 treatments/slide; italic only in quotes; font digit rendering verified |
