...
| **Font discipline** | Strictly 2 font identities, body ≥2.5rem, headings ≥4.4rem, line-height 1.3-1.45, bold ≤15% | 3+ fonts, numbers in different font; >3 type treatments on one slide; italic outside quotes; blacklisted font for number-heavy deck; body text below 2.5rem; headings below 4.4rem | Mostly 2 but some inconsistency; body at 2.5rem but no dramatic scale contrast | Exactly 2 fonts, numbers consistent; max 3 treatments/slide; italic only in quotes; font digit rendering verified; body ≥2.5rem, headings ≥4.4rem, hero numbers ≥8rem |
